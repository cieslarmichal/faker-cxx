...
TEST_P(SportTestLocale, shouldGenerateFemaleAthleteLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(sportDefinition.femaleAthletes,
...
TEST_P(SportTestLocale, shouldGenerateMaleAthleteLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(sportDefinition.maleAthletes,
                                    [generatedMaleAthlete](const std::string_view& maleAthlete)
...
TEST_P(SportTestLocale, shouldGenerateSoccerTeamLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(sportDefinition.soccerTeams,
                                    [generatedSoccerTeam](const std::string_view& soccerTeam)
...
TEST_P(SportTestLocale, shouldGenerateSportEventLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(sportDefinition.sportEvents,
                                    [generatedSportEvent](const std::string_view& sportEvent)
