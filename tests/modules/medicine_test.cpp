...
TEST_P(MedicineTestLocale, shouldGenerateMedicalConditionLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(medicalDefinition.medicalConditions,
...
TEST_P(MedicineTestLocale, shouldGenerateMedicalTestLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(medicalDefinition.medicalTests,
                                    [generatedMedicalTest](const std::string_view& medicalTest)
...
TEST_P(MedicineTestLocale, shouldGenerateSpecialtyLocale)
{
    ...
    ASSERT_TRUE(std::ranges::any_of(medicalDefinition.specialties,
                                    [generatedSpecialty](const std::string_view& specialty)
