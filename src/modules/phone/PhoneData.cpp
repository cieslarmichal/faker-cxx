...
const std::array<std::string_view, 6> PhonePlatforms = {"Android OS", "Palm OS",       "Symbian",
...
const std::array<std::string_view, 9> PhoneManufacturers = {"Apple", "Google",  "Huawei", "Motorola", "OnePlus",
