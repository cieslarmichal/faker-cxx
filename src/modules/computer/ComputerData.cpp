...
const std::array<std::string_view, 5> cpuManufacturers = {
...
const std::array<std::string_view, 5> gpuManufacturers = {
    "NVIDIA", "AMD", "Intel", "ARM", "Qualcomm",
};

const std::array<std::string_view, 2> gpuTypes = {
    "Integrated",
    "Discrete",
};

const std::array<std::string_view, 23> gpuModels = {
