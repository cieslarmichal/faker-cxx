...
const auto computerManufacturers = std::to_array<std::string_view>({
    ...
    "Microsoft Surface", "Google", "Huawei", "Razer", "Xiaomi", "Sharp", "Zotac", "MSI", "Gigabyte", "ECS",
    "Intel", "Vizio", "OnePlus", "Meizu", "Vivo", "Asrock", "Acer Predator", "Medion", "Oculus", "Corsair",
    "BenQ", "Corsair", "Aorus", "Porsche Design", "Dynabook", "Toshiba Tecra", "Epson", "Rock", "Clevo", "EVGA",
});
