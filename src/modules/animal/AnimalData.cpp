...
const std::array<std::string_view, 8> bears = {"Giant panda",         "Spectacled bear",  "Sun bear",   "Sloth bear",
                                               "American black bear", "Asian black bear", "Brown bear", "Polar bear"};

const std::array<std::string_view, 914> birds = {"Red-throated Loon",
                                                 "Arctic Loon",
                                                 "Pacific Loon",
                                                 "Common Loon",
                                                 "Yellow-billed Loon",
...
const std::array<std::string_view, 55> cats = {"Abyssinian",
                                               "American Bobtail",
                                               "American Curl",
                                               "American Shorthair",
                                               "American Wirehair",
...
const std::array<std::string_view, 54> cetaceans = {"Blue Whale",
                                                    "Fin Whale",
                                                    "Sei Whale",
                                                    "Sperm Whale",
                                                    "Bryde’s whale",
...
const std::array<std::string_view, 495> cows = {"Aberdeen Angus",
                                                "Abergele",
                                                "Abigar",
                                                "Abondance",
...
const std::array<std::string_view, 24> crocodiles = {"Alligator mississippiensis",
                                                     "Chinese Alligator",
                                                     "Black Caiman",
...
const std::array<std::string_view, 497> dogs = {"Affenpinscher",
                                                "Afghan Hound",
                                                "Aidi",
                                                "Airedale Terrier",
                                                "Akbash",
...
const std::array<std::string_view, 95> fishes = {"Grass carp",
                                                 "Peruvian anchoveta",
                                                 "Silver carp",
                                                 "Common carp",
                                                 "Asari",
...
const std::array<std::string_view, 345> horses = {"American Albino",
                                                  "Abaco Barb",
                                                  "Abtenauer",
                                                  "Abyssinian",
                                                  "Aegidienberger",
...
const std::array<std::string_view, 129> insects = {"Acacia-ants",
                                                   "Acorn-plum gall",
                                                   "Aerial yellowjacket",
...
const std::array<std::string_view, 7> lions = {
    "Asiatic Lion", "Barbary Lion",   "West African Lion", "Northeast Congo Lion",
    "Masai Lion",   "Transvaal lion", "Cape lion"};

const std::array<std::string_view, 49> rabbits = {"American",
                                                  "American Chinchilla",
                                                  "American Fuzzy Lop",
                                                  "American Sable",
                                                  "Argente Brun",
...
const std::array<std::string_view, 185> rodents = {"Abrocoma",
                                                   "Abrocoma schistacea",
                                                   "Aconaemys",
                                                   "Aconaemys porteri",
...
const std::array<std::string_view, 576> snakes = {"Viper Adder",
                                                  "Common adder",
                                                  "Death Adder",
                                                  "Desert death adder",
                                                  "Horned adder",
...
const std::array<std::string_view, 13> types = {"dog",        "cat", "snake", "bear", "lion",   "cetacean", "insect",
