...
const std::array<std::string_view, 55> cats = {
    "Abyssinian",
    "American Bobtail",
    "American Curl",
    "American Shorthair",
...
const std::array<std::string_view, 54> cetaceans = {
    "Blue Whale",
    "Fin Whale",
    "Sei Whale",
    "Sperm Whale",
...
const std::array<std::string_view, 24> crocodiles = {
...
const std::array<std::string_view, 497> dogs = {
    "Affenpinscher",
    "Afghan Hound",
    "Aidi",
    "Airedale Terrier",
...
const std::array<std::string_view, 95> fishes = {
    "Grass carp",
    "Peruvian anchoveta",
    "Silver carp",
    "Common carp",
...
const std::array<std::string_view, 345> horses = {
    "American Albino",
    "Abaco Barb",
    "Abtenauer",
    "Abyssinian",
...
const std::array<std::string_view, 129> insects = {
    "Acacia-ants",
    "Acorn-plum gall",
    "Aerial yellowjacket",
...
const std::array<std::string_view, 49> rabbits = {
    "American",
    "American Chinchilla",
    "American Fuzzy Lop",
    "American Sable",
...
const std::array<std::string_view, 185> rodents = {
    "Abrocoma",
    "Abrocoma schistacea",
    "Aconaemys",
    "Aconaemys porteri",
...
const std::array<std::string_view, 576> snakes = {
    "Viper Adder",
    "Common adder",
    "Death Adder",
    "Desert death adder",
...
const std::array<std::string_view, 13> types = {
    "dog", "cat", "snake", "bear", "lion", "cetacean", "insect", "crocodilia", "cow", "bird", "fish", "rabbit", "horse",
};
}
