...
const std::array<std::string_view, 4> types = { "Desktop", "Laptop", "Mainframe", "Supercomputer" };

const std::array<std::string_view, 20> manufacturers = { "Apple", "Dell", "HP", "Lenovo", "Acer",
    "Asus", "Microsoft", "Samsung", "Toshiba", "Sony", "MSI", "Gateway", "Fujitsu", "HCL",
    "Panasonic", "LG", "IBM", "Compaq", "Alienware", "Razer" };

// todo - it is possible to link the models to brands in the future.
const std::array<std::string_view, 45> models = { "MacBook Air", "MacBook Pro", "iMac", "Mac mini",
    "Inspiron", "XPS", "Alienware", "Latitude", "Precision", "Spectre", "Envy", "Pavilion",
    "EliteBook", "ThinkPad", "Yoga", "Legion", "IdeaPad", "Aspire", "Predator", "TravelMate",
    "Swift", "ZenBook", "ROG", "VivoBook", "TUF", "Surface Laptop", "Surface Pro", "Surface Book",
    "Galaxy Book", "Notebook", "Odyssey", "Satellite", "VAIO", "GS Series", "GE Series",
    "GL Series", "ThinkCentre", "ThinkStation", "Presario", "Area-51", "m15", "Aurora", "Blade",
    "Blade Stealth", "NUC" };

const std::array<std::string_view, 5> cpu_manufacturers = { "Intel", "AMD", "ARM", "IBM", "Apple" };

const std::array<std::string_view, 12> cpu_types
    = { "Dual-Core", "Quad-Core", "Hexa-Core", "Octa-Core", "Deca-Core",
          "Heterogeneous System Architecture", "ARM", "x86", "64-bit", "32-bit", "RISC", "CISC" };

const std::array<std::string_view, 26> cpu_models
...
const std::array<std::string_view, 5> gpu_manufacturers = {
    "NVIDIA",
    "AMD",
    "Intel",
    "ARM",
...
const std::array<std::string_view, 2> gpu_types = { "Integrated", "Discrete" };

const std::array<std::string_view, 23> gpu_models
