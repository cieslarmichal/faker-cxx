...
const std::array<std::string_view, 7> vehicle_colors = {"Black", "Blue", "Gray", "Green", "Red", "Silver", "White"};

const std::array<std::string_view, 10> fuel_types = {"Biodiesel", "Diesel",   "Electric", "Ethanol",     "Gasoline",
...
const std::array<std::string_view, 14> models = {"Accord",  "CR-V",     "Camry",    "Civic",         "Corolla",
                                                 "Escape",  "Explorer", "F-150",    "Fiesta",        "Focus",
                                                 "Mustang", "RAV4",     "Ram 1500", "Silverado 1500"};

const std::array<std::string_view, 10> vehicle_types = {"Boat", "Bus", "Car",     "Minivan", "Motorcycle",
