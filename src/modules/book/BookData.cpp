...
const std::array<std::string_view, 4> bookFormats{
    "Paperback",
    "Hardcover",
    "Ebook",
    "Audiobook",
...
const std::array<std::string_view, 25> bookGenres = {
...
const std::array<std::string_view, 263> publishers = {
    "Academic Press",
    "Ace Books",
    "Addison-Wesley",
    "Adis International",
...
const std::array<std::string_view, 34> bookSeries = {
...
const std::array<std::string_view, 102> titles = {
