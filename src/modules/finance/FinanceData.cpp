...
const std::array<Finance::IbanCountry, 27> ibanCountries{
...
const std::array<std::string_view, 2> americanExpressCreditCardFormats = {
    "34##-######-####L",
    "37##-######-####L",
};

const std::array<std::string_view, 6> discoverCreditCardFormats = {
    "6011-####-####-###L",      "65##-####-####-###L",      "64[4-9]#-####-####-###L",
    "6011-62##-####-####-###L", "65##-62##-####-####-###L", "64[4-9]#-62##-####-####-###L",
};

const std::array<std::string_view, 2> masterCardCreditCardFormats = {
    "5[1-5]##-####-####-###L",
    "6771-89##-####-###L",
};

const std::array<std::string_view, 2> visaCreditCardFormats = {
    "4###########L",
    "4###-####-####-###L",
};

const std::array<Finance::CreditCardType, 4> creditCardTypes = {
...
const std::array<std::string_view, 4> creditCardNames = {
    "Visa",
    "American Express",
    "MasterCard",
    "Discover",
...
const std::array<Currency, 154> currencies = {{{
                                                   "UAE Dirham",
                                                   "AED",
                                                   "",
                                               },
