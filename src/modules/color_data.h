...
const auto englishColors = std::to_array<std::string_view>({
    ...
    "sky blue", "tan",    "teal",     "turquoise", "violet",  "white",  "yellow", "amber", "apricot", "beige", 
    "bronze", "charcoal", "cherry", "chocolate", "copper", "coral", "cream", "crimson", "denim", "eggplant",
    "emerald", "flamingo", "forest green", "graphite", "jade", "lemon", "lilac", "mahogany", "mustard", "navy", "ochre",
    "peach", "periwinkle", "rose", "ruby", "rust", "sapphire", "scarlet", "sepia",
