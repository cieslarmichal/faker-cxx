...
{
const auto actors = std::to_array<std::string_view>({"Aamir Khan",
                                                     "Abbott and Costello",
                                                     "Adel Imam",
                                                     "Ahmed Zaki",
                                                     "Al Pacino",
...
const auto actresses = std::to_array<std::string_view>({"Agnes Moorehead",
                                                        "Aishwarya Rai",
                                                        "Alida Valli",
                                                        "Amy Adams",
                                                        "Angela Bassett",
...
const auto directors = std::to_array<std::string_view>({"Abbas Kiarostami",
                                                        "Abel Gance",
                                                        "Agnès Varda",
                                                        "Aki Kaurismäki",
                                                        "Akira Kurosawa",
...
const auto movies =
    std::to_array<std::string_view>({"12 Angry Men",
...
const auto tvShows = std::to_array<std::string_view>({"Africa",
