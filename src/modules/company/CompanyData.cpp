...
const std::array<std::string_view, 40> buzzNouns = {"synergies",
                                                    "paradigms",
                                                    "markets",
                                                    "partnerships",
                                                    "infrastructures",
...
const std::array<std::string_view, 100> catchPhraseAdjectives = {"Adaptive",
                                                                 "Advanced",
                                                                 "Ameliorated",
                                                                 "Assimilated",
                                                                 "Automated",
...
const std::array<std::string_view, 101> catchPhraseDescriptors = {"24 hour",
                                                                  "24/7",
                                                                  "3rd generation",
                                                                  "4th generation",
                                                                  "5th generation",
...
const std::array<std::string_view, 104> catchPhraseNouns = {"ability",
                                                            "access",
                                                            "adapter",
                                                            "algorithm",
                                                            "alliance",
