...
const auto enUSPlayers = std::to_array<std::string_view>(
    ...
    "Alpha Kep", "Alpha54", "apEX", "Arsenal", "Atomic", "autimatic", "AyyJayy", "BeastMode", "Brollan",
    "chrisJ", "Chicago", "coldzera", "Daniel", "dev1ce", "Dosia", "dupreeh", "Edward", "fairy Peak!",
    "FalleN", "Fer", "Firstkiller", "flamie", "flusha", "fnx", "Gimmick", "Gla1ve", "Gyro", "Happy",
    "itachi", "JKnaps", "jstn", "JW", "Kjaerbye", "KIOSHIMA", "Kronovi", "kennyS", "Kaydop", "KRiMZ",
    "Lekr0", "Magisk", "M0nkey M00n", "Mist", "Mist", "NBK", "neo", "NAF", "Niko", "Noly", "olofmeister",
    "pashaBiceps", "Rettles", "Rain", "Rise", "Rizzo", "Rush", "Sam", "Scrub Killa", "Seikoo", "shox",
    "s1mple", "Skadoodle", "snax", "Speed", "SquishyMuffinz", "Stewie2K", "Sypical", "TACO", "Tarik",
    "Torment", "Tox", "Turbopolsa", "Vatira", "ViolentPanda", "Xizt", "Xyp9x", "Yukeo", "Zen", "Zeus",
    "ZywOo",
});
...
const auto enUSTeams = std::to_array<std::string_view>(
    {"Team Liquid",      "G2 Esports", "OpTic Gaming", "Natus Vincere", "Astralis",    "NRG",
     ...
     "Gambit Esports",   "BDS",        "Gentle Mates", "Team SoloMid", "SK Gaming", "Luminosity Gaming", "Renegades", "Envy", "Mad Lions", "Immortals",
    "OG", "Alliance", "Echo Fox", "Gen.G", "DRX", "DetonatioN FocusMe", "Rare Atom", "Team Falcons",
    "Boom Esports", "Tundra Esports", "Blacklist International", "Falcons Esports", "Falcon Esports",
    "Team Spirit", "HellRaisers", "PSG Talon", "Team SMG", "Invictus Gaming", "LGD Gaming"
...
const auto enUSLeagues = std::to_array<std::string_view>(
    {"LEC", "LPL", "LCK", "LCS NA", "LFL", "PUBG Mobile Super League", "VCT", "VCT GC", "F1 Esports Series",
     "Overwatch League", "Superliga", "Prime League", "TCL", "Call of Duty League", "RLCS", "Dota Pro Circuit", "ESL Pro League",
     "DreamLeague", "BLAST Premier", "IEM (Intel Extreme Masters)",
     "Champions Tour Pacific", "Asia Pacific Predator League", "EMEA Masters", "Challengers Korea",
     "PCS (Pacific Championship Series)", "Worlds", "MSI", "Arena of Valor International Championship",
     "Garena Free Fire World Series", "Mobile Legends: Bang Bang Pro League"
});
