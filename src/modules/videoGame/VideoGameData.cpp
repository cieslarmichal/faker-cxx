...
const std::array<std::string_view, 28> videoGameGenres = {"Action",
                                                          "Adventure",
                                                          "Battle royale",
                                                          "Dating sim",
                                                          "Endless runner",
...
const std::array<std::string_view, 9> platforms = {"Android",       "Linux",  "Nintendo Switch", "Oculus Quest", "PC",
                                                   "Playstation 5", "Stadia", "Xbox Series X",   "iOS"};

const std::array<std::string_view, 392> studioNames = {"0verflow",
