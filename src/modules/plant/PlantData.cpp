...
namespace faker
{
const std::array<std::string_view, 47> trees = {
    "Oak",          "Maple",     "Pine",    "Birch",        "Willow",       "Cherry Blossom",
    "Cypress",      "Palm",      "Redwood", "Dogwood",      "Ash",          "Cedar",
    "Fir",          "Poplar",    "Beech",   "Eucalyptus",   "Juniper",      "Sycamore",
    "Hemlock",      "Spruce",    "Mango",   "Apple",        "Orange",       "Lemon",
    "Avocado",      "Almond",    "Walnut",  "Chestnut",     "Bamboo",       "Papaya",
    "Peach",        "Pineapple", "Banana",  "Acacia",       "Hickory",      "Cottonwood",
    "Baobab",       "Catalpa",   "Ginkgo",  "Chestnut Oak", "Black Walnut", "Japanese Maple",
    "Crape Myrtle", "Kapok",     "Mimosa",  "Linden",       "Tamarind"};
...
const std::array<std::string_view, 295> shrubs = {"Abelia",        "Actinidia",      "Aloe",
