...
const auto bicCountries = std::to_array<BicCountry>(
    {BicCountry::Poland, BicCountry::UnitedStates, BicCountry::UnitedKingdom, BicCountry::Germany, BicCountry::Romania,
     BicCountry::France, BicCountry::Italy, BicCountry::Spain, BicCountry::Netherlands, BicCountry::India});

const auto ibanCountries = std::to_array<IbanCountry>({
    IbanCountry::Austria,   IbanCountry::Belgium,    IbanCountry::Bulgaria, IbanCountry::Croatia,
    IbanCountry::Cyprus,    IbanCountry::Czechia,    IbanCountry::Denmark,  IbanCountry::Estonia,
    IbanCountry::Finland,   IbanCountry::France,     IbanCountry::Germany,  IbanCountry::Greece,
...
const std::unordered_map<BicCountry, std::vector<std::string_view>> bicCountriesCodes = {
    {BicCountry::Poland,
     {"BPKOPLPW", "PKOPPLPW", "BREXPLPWMUL", "BNPAPLP", "POLUPLPR", "BIGBPLPW", "WBKPPLPP", "CITIPLPX", "INGBPLPW",
      "DEUTPLPK", "DEUTPLP"}},
    {BicCountry::UnitedStates, {"BOFAUS3N", "CITIUS33", "WELLSFARGO", "USBKUS44", "CHASUS33", "HSBCUS33", "PNCCUS33"}},
    {BicCountry::UnitedKingdom, {"BARCGB22", "HSBCKENW", "LOYDGB21", "NWBKGB2L", "RBOSGB2L", "HSBCGB2L", "DEUTGB2L"}},
    {BicCountry::Germany,
